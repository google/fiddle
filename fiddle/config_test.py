...
class OrderedArgumentsTest(parameterized.TestCase):
  ...
  @parameterized.parameters([
      ...
      (False, True, False, False, [('arg2', 5), ('kwarg1', None),
                                   ('kwarg2', 99)]),
      (False, False, True, False, [('arg1', inspect.Parameter.empty),
                                   ('arg2', 5), ('kwarg2', 99)]),
      (False, True, True, False, [('arg1', inspect.Parameter.empty),
                                  ('arg2', 5), ('kwarg1', None),
                                  ('kwarg2', 99)]),
      (True, False, False, False, [('arg2', 5), ('kwarg2', 99), ('foo', 12)]),
      (True, True, False, False, [('arg2', 5), ('kwarg1', None), ('kwarg2', 99),
                                  ('foo', 12)]),
      (True, False, True, False, [('arg1', inspect.Parameter.empty),
                                  ('arg2', 5), ('kwarg2', 99), ('foo', 12)]),
      (True, True, True, False, [('arg1', inspect.Parameter.empty), ('arg2', 5),
