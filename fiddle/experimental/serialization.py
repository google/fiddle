...
def register_standard_object(object_type: Type[Any]):
  """Registers serialization support for the given `object_type`.

  This adds serialization support for "standard" Python objects, where here
  standard means that we can simply serialize the `object_type.__dict__`
