...
import libcst as cst  # pylint: disable=unused-import
...
def auto_config(
  ...
  def make_auto_config(fn):
    ...
    # Testing if this is consuming too much memory:
    x_module = inspect.getmodule(fn)
    x_filename = inspect.getsourcefile(fn)
    linecache.getlines(x_filename, x_module.__dict__)
