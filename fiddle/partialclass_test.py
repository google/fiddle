...
"""Tests for the `fiddle.partial` module."""
...
class TestClass(metaclass=TestMetaClass):
  """A test class for testing partialclass.partialclass."""
...
class PartialTest(absltest.TestCase):
  ...
  def test_partial_class(self):
    partial_class = partialclass.partialclass(TestClass, 1, kwarg2='kwarg2')
  ...
  def test_partial_namedtuple(self):
    partial_class = partialclass.partialclass(
        TestNamedTuple, 1, kwarg2='kwarg2')
